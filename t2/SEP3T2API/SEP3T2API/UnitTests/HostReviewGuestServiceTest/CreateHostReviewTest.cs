...
{
    [TestFixture]
    public class CreateHostReviewTest
    {
        ...
        [TestCase(10)]
        [TestCase(100)]
        public void CreateHostReview_InvalidRating_ThrowsArgumentException(int rating)
        {
            ...
            Assert.ThrowsAsync<ArgumentException>(async () =>
                await _hostReviewService.CreateHostReviewAsync(hostReview));
        }
        ...
        [TestCase(4)]
        [TestCase(5)]
        public void CreateHostReview_ValidRating_DoesNotThrow(int rating)
        {
            HostReview hostReview = new HostReview()
            {
                CreatedDate = new DateTime(),
