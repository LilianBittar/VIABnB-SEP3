...
class ResidenceControllerTest
{
  ...
  @Test public void registerANullResidenceReturnsBadRequestTest()
  {
    Residence residenceTest = null;
    assertEquals(ResponseEntity.badRequest().build(),
        controller.createResidence(residenceTest));
  }

  @Test public void failureOnCreateResidenceReturnsInternalServerErrorTest()
  {
    Residence residenceTest = new Residence(1, address, "Test", "Test", true,
        11, new ArrayList<>(), new ArrayList<>(), "Test", null, null, 3, host,
        new ArrayList<>());
  ...
  @Test public void getAllReturnsInternalServerErrorWhenIllegalStateExceptionIsThrown()
  {
  ...
  @Test public void createReviewReturnsInternalServerErrorWhenDAOThrowsIllegalArgumentException()
  {
    Residence residence = new Residence(1, address, "Test", "Test", true, 11,
        new ArrayList<>(), new ArrayList<>(), "Test", null, null, 3, host,
        new ArrayList<>());
    ResidenceReview residenceReview = new ResidenceReview(1, "test", 293886,
        LocalDate.now());
