...
public class RentRequest
{
  ...
  public RentRequest(int id, LocalDate startDate, LocalDate endDate,
      int numberOfGuests, RentRequestStatus status, Guest guest,
      Residence residence, LocalDate requestCreationDate)
  {
    this.id = id;
