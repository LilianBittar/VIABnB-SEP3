...
public class GuestDAOImpl extends BaseDao implements GuestDAO {
    ...
    public List<Guest> getAllGuests() {
        try (Connection connection = getConnection()) {
            ...
            while (result.next()) {
                List<GuestReview> guestReview = getGuestReviewsByGuestId(result.getInt("userid"));
    ...
    @Override
    public List<Guest> getAllNotApprovedGuests() {
    ...
    private List<GuestReview> getGuestReviewsByGuestId(int guestId) {
        try (Connection connection = getConnection()) {
            PreparedStatement stm = connection.prepareStatement("SELECT * FROM guestreview  where guestid = ?");
