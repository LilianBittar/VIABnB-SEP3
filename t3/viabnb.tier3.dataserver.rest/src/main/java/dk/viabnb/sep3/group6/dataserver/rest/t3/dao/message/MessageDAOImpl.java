...
public class MessageDAOImpl extends BaseDao implements MessageDAO {
    ...
    public Message create(Message message) {
        try (Connection connection = getConnection()) {
            PreparedStatement stm = connection.prepareStatement("INSERT INTO message(senderid, receiverid, " +
    ...
    public List<Message> getAll() {
        try (Connection connection = getConnection()) {
            ...
            while (result.next()) {
                ...
                Message message = new Message(sender, receiver, result.getString("messagecontent"),
